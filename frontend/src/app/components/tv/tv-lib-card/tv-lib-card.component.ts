...
@Component({
  ...
  template: `
    <div class="group relative w-[300px] flex flex-col gap-4 pt-3 rounded-3xl">
      <div class="absolute w-full h-[300px] rounded-3xl group-hover:bg-blue-light duration-100 delay-75 ease-out"></div>
      <img
        draggable="false"
        src="{{ imgUrl }}"
        class="w-full h-[300px] rounded-3xl object-cover group-hover:translate-x-2 group-hover:-translate-y-2 duration-100 delay-75 ease-out"
      />
      <div>
