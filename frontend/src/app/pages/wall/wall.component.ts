...
export class WallComponent implements OnInit {
  //TODO lyrics when I restart the song they do not restart here (we need refresh)
  ...
  lyricStart: number = 0; //These are for lyrics
  lyricEnd: number = 3;
  counter: number = 2;
  ...
  lyrics: any[] = [
    ...
    { line: 32, start: 190, end: 204, text: "No, I can't sleep until I feel your touch" },
  ];
  ...
  ngOnInit(): void {
    ...
    this.songPlayingService.currentTime$.subscribe((time) => {
      ...
      if (this.songCurrentTime > this.lyrics[this.counter].end) {
        this.counter += 3; //counter for array of lyrics
